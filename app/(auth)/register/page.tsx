      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex items-center justify-center space-x-4">
          <div className={`flex items-center ${step === "account" ? "text-primary-600" : "text-gray-400"}`}>
            <span className={`w-8 h-8 flex items-center justify-center rounded-full border-2 ${step === "account" ? "border-primary-600 bg-primary-600 text-white" : "border-gray-300"}`}>
              1
            </span>
            <span className="ml-2 text-sm font-medium">Account</span>
          </div>
          <div className="w-8 h-0.5 bg-gray-300"></div>
          <div className={`flex items-center ${step === "family" ? "text-primary-600" : "text-gray-400"}`}>
            <span className={`w-8 h-8 flex items-center justify-center rounded-full border-2 ${step === "family" ? "border-primary-600 bg-primary-600 text-white" : "border-gray-300"}`}>
              2
            </span>
